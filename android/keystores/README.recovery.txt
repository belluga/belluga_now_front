...
6. Expect the build to fail closed if the public file is missing, if `applicationId` or `appLinkHosts` is missing from that public file, or if the secret signing file is missing.
