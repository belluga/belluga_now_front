...
class AccountProfileDetailRouteResolver
    implements RouteModelResolver<AccountProfileComplete> {
  ...
  @override
  Future<AccountProfileComplete> resolve(RouteResolverParams params) async {
    ...
    final accountProfile = await _accountProfilesRepository
        .getAccountProfileBySlug(
