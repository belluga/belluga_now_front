...
import 'package:belluga_now/presentation/tenant_admin/settings/models/tenant_admin_settings_integration_section.dart'
    as _i73;
import 'package:belluga_now/presentation/tenant_admin/settings/routes/tenant_admin_home_favorites_pinned_profile_route.dart'
    as _i40;
...
class AccountDeletionResolutionRoute extends _i65.PageRouteInfo<void> {
  const AccountDeletionResolutionRoute({List<_i65.PageRouteInfo>? children})
...
class CityMapRoute extends _i65.PageRouteInfo<CityMapRouteArgs> {
  CityMapRoute({
    ...
    String? poi,
    String? stack,
    _i67.LocationPermissionGateResult? locationGateResult,
    List<_i65.PageRouteInfo>? children,
  }) : super(
         CityMapRoute.name,
...
class CityMapRouteArgs {
  ...
  final _i67.LocationPermissionGateResult? locationGateResult;
...
class ContactGroupManagementRoute extends _i65.PageRouteInfo<void> {
  const ContactGroupManagementRoute({List<_i65.PageRouteInfo>? children})
...
class LocationPermissionRoute
  ...
  LocationPermissionRoute({
    ...
    _i66.ValueChanged<_i67.LocationPermissionGateResult>? onResult,
...
class LocationPermissionRouteArgs {
  ...
  final _i66.ValueChanged<_i67.LocationPermissionGateResult>? onResult;
...
/// generated route for
/// [_i26.TenantAdminAccountProfileExternalLinkAddRoutePage]
class TenantAdminAccountProfileExternalLinkAddRoute
    extends
        _i65.PageRouteInfo<TenantAdminAccountProfileExternalLinkAddRouteArgs> {
  ...
  static _i65.PageInfo page = _i65.PageInfo(
    ...
    builder: (data) {
      ...
      return _i26.TenantAdminAccountProfileExternalLinkAddRoutePage(
        key: args.key,
        accountSlug: args.accountSlug,
        accountProfileId: args.accountProfileId,
...
/// generated route for
/// [_i27.TenantAdminAccountProfileExternalLinkEditRoutePage]
class TenantAdminAccountProfileExternalLinkEditRoute
    extends
        _i65.PageRouteInfo<TenantAdminAccountProfileExternalLinkEditRouteArgs> {
  ...
  static _i65.PageInfo page = _i65.PageInfo(
    ...
    builder: (data) {
      ...
      return _i27.TenantAdminAccountProfileExternalLinkEditRoutePage(
        key: args.key,
        accountSlug: args.accountSlug,
        accountProfileId: args.accountProfileId,
...
class TenantAdminAccountProfileGroupMembersRoute
    extends _i65.PageRouteInfo<TenantAdminAccountProfileGroupMembersRouteArgs> {
...
class TenantAdminDiscoveryFilterSurfaceRoute
    extends _i65.PageRouteInfo<TenantAdminDiscoveryFilterSurfaceRouteArgs> {
...
class TenantAdminDiscoveryFiltersRoute extends _i65.PageRouteInfo<void> {
  const TenantAdminDiscoveryFiltersRoute({List<_i65.PageRouteInfo>? children})
...
class TenantAdminEventOccurrenceGroupMembersRoute
    extends
        _i65.PageRouteInfo<TenantAdminEventOccurrenceGroupMembersRouteArgs> {
...
/// generated route for
/// [_i40.TenantAdminHomeFavoritesPinnedProfileRoutePage]
class TenantAdminHomeFavoritesPinnedProfileRoute
    extends _i65.PageRouteInfo<void> {
  const TenantAdminHomeFavoritesPinnedProfileRoute({
    List<_i65.PageRouteInfo>? children,
  }) : super(
         TenantAdminHomeFavoritesPinnedProfileRoute.name,
         initialChildren: children,
       );

  static const String name = 'TenantAdminHomeFavoritesPinnedProfileRoute';

  static _i65.PageInfo page = _i65.PageInfo(
    name,
    builder: (data) {
      return const _i40.TenantAdminHomeFavoritesPinnedProfileRoutePage();
    },
  );
}
...
class TenantAdminSettingsDomainsRoute extends _i65.PageRouteInfo<void> {
  const TenantAdminSettingsDomainsRoute({List<_i65.PageRouteInfo>? children})
...
class TenantAdminSettingsTechnicalIntegrationsRoute
    extends
        _i65.PageRouteInfo<TenantAdminSettingsTechnicalIntegrationsRouteArgs> {
