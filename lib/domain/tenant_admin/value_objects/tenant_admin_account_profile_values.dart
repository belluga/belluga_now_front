...
TenantAdminAccountProfile tenantAdminAccountProfileFromRaw({
  ...
  bool? isActive,
  Object? deletedAt,
  Object? parentAccountPublicationStatus,
  Object? adminAvatarUrl,
  Object? adminCoverUrl,
  Object? bio,
  ...
  return TenantAdminAccountProfile(
    ...
    visibilityValue: tenantAdminOptionalText(visibility),
    isActiveValue: tenantAdminFlag(isActive),
    deletedAtValue: tenantAdminOptionalText(deletedAt),
    parentAccountPublicationStatusValue: tenantAdminOptionalText(
      parentAccountPublicationStatus,
    ),
    adminAvatarUrlValue: tenantAdminOptionalUrl(adminAvatarUrl),
    adminCoverUrlValue: tenantAdminOptionalUrl(adminCoverUrl),
