...
class TenantAdminProfileTypeDefinition {
  ...
  final TenantAdminCountValue capabilityRevisionValue;
  ...
  int get capabilityRevision => capabilityRevisionValue.value;
