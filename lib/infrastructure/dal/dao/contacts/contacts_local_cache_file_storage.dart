...
class ContactsLocalCacheFileStorage implements ContactsLocalCacheStorageContract {
  ContactsLocalCacheFileStorage({
    Future<Directory> Function()? directoryProvider,
  }) : _directoryProvider =
            directoryProvider ?? _defaultContactsLocalCacheDirectory;

  final Future<Directory> Function() _directoryProvider;

  static Future<Directory> _defaultContactsLocalCacheDirectory() async {
    final supportDirectory = await getApplicationSupportDirectory();
    final cacheDirectory =
        Directory('${supportDirectory.path}/contacts_local_cache');
