...
@RoutePage(name: 'TenantAdminAccountProfileExternalLinkEditRoute')
class TenantAdminAccountProfileExternalLinkEditRoutePage
    extends
        ResolverRoute<
          TenantAdminAccountProfileExternalLinkRouteModel,
          TenantAdminModule
        > {
  const TenantAdminAccountProfileExternalLinkEditRoutePage({
    super.key,
