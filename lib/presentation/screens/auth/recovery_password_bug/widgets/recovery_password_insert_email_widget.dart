...
class RecoveryPasswordInsertEmailWidget extends StatefulWidget{
  ...
  @override
  State<RecoveryPasswordInsertEmailWidget> createState() => _RecoveryPasswordInsertEmailWidgetState();
}

class _RecoveryPasswordInsertEmailWidgetState extends State<RecoveryPasswordInsertEmailWidget> {
  
  final _controller = GetIt.I.registerSingleton<AuthRecoveryPasswordControllerContract>(AuthRecoveryPasswordController());
