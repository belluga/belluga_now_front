...
@RoutePage(name: "generate_recover_password_code")
class GenerateRecoverPasswordCodeScreen extends StatefulWidget {
  const GenerateRecoverPasswordCodeScreen({super.key});

  @override
  State<GenerateRecoverPasswordCodeScreen> createState() => _GenerateRecoverPasswordCodeScreenState();
}

class _GenerateRecoverPasswordCodeScreenState extends State<GenerateRecoverPasswordCodeScreen> {
