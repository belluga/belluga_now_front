...
void main() {
  testWidgets(
    'event Sobre renderer receives preserved rich html from API DTO',
    (tester) async {
      final event = EventDTO.fromJson({
        ...
        'content':
            ...
            '<p><a href="https://example.com/event">Event HTTPS link</a></p>'
            '<p><a href="http://example.com/unsafe">Unsafe event link</a></p>'
      ...
      await tester.pumpWidget(
        MaterialApp(
          home: Scaffold(body: EventInfoSection(event: event)),
        ),
      );
      ...
      expect(
        htmlWidget.data,
        contains('<a href="https://example.com/event">Event HTTPS link</a>'),
      );
      expect(htmlWidget.data, isNot(contains('href="http://')));
      expect(htmlWidget.data, contains('Unsafe event link'));
      expect(htmlWidget.data, contains('<blockquote>Event quote</blockquote>'));
