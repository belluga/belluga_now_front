...
void main() {
  ...
  test('allows navigation in tenant environment', () {
  ...
  test('redirects landlord env to landlord home when session is not active',
      () {
    _registerAppData(_buildAppData(
  ...
  test(
      'redirects landlord env to admin when session and landlord mode are active',
      () {
    _registerAppData(_buildAppData(
      hostname: 'landlord.test',
      envType: 'landlord',
  ...
  test(
      'falls back to landlord home when landlord repositories are not registered',
      () {
    _registerAppData(_buildAppData(
      hostname: 'landlord.test',
      envType: 'landlord',
