...
void main() {
  ...
  testWidgets(
    'Login persists registered identity across restart',
    (tester) async {
      ...
      final email = 'login-regression-$now@belluga.test';
      const password = 'SecurePass!123';

      await authRepository.signUpWithEmailPassword(
        authRepoString('Login Regression'),
