...
class LintRuleNodeRegistry {
  ...
  void addFunctionDeclaration(
    void Function(FunctionDeclaration node) callback,
  ) {
  ...
  void addPrefixedIdentifier(void Function(PrefixedIdentifier node) callback) {
  ...
  void addVariableDeclaration(
    void Function(VariableDeclaration node) callback,
  ) {
